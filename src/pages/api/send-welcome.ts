...
export const POST = async ({ request }) => {
  ...
  try {
    ...
    const title = isPro
      ...
      : "¡Bienvenido a deOficiosArgentina! 🚀";
    ...
    const ctaLink = isPro
      ? "https://deoficiosargentina.com.ar/mi-perfil"
      : "https://deoficiosargentina.com.ar/resultados";
    ...
    <head>
      ...
      <title>Bienvenido a deOficiosArgentina</title>
    </head>
    <body style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; background-color: #f9fafb; margin: 0; padding: 0; color: #1f2937;">
      ...
      <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 0; border-radius: 16px; margin-top: 40px; margin-bottom: 40px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06); overflow: hidden;">
        ...
        <div style="background: linear-gradient(135deg, #ea580c 0%, #c2410c 100%); padding: 40px 20px; text-align: center;">
          <h1 style="color: #ffffff; margin: 0; font-size: 28px; font-weight: 800; letter-spacing: -0.5px;">deOficiosArgentina</h1>
        ...
        <div style="background-color: #f3f4f6; padding: 30px; text-align: center; border-top: 1px solid #e5e7eb;">
          <p style="color: #6b7280; font-size: 12px; margin-bottom: 10px;">
            © ${new Date().getFullYear()} deOficiosArgentina - Todos los derechos reservados.
          </p>
          <div style="margin-bottom: 20px;">
            <a href="https://instagram.com/deoficiosargentina" style="color: #9ca3af; text-decoration: none; margin: 0 10px;">Instagram</a>
            <a href="https://deoficiosargentina.com.ar" style="color: #9ca3af; text-decoration: none; margin: 0 10px;">Web</a>
          </div>
          <p style="color: #9ca3af; font-size: 11px; max-width: 400px; margin: 0 auto;">
            Estás recibiendo este correo porque te registraste en deOficiosArgentina. Si no fuiste tú, por favor ignora este mensaje.
          </p>
        </div>
    ...
    const data = await resend.emails.send({
      from: "deOficiosArgentina <hola@deoficiosargentina.com.ar>",
      to: [email],
      subject: title,
      html: htmlContent,
    });
